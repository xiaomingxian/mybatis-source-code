...
public class DefaultSqlSession implements SqlSession {
    ...
    // eg1:  object={"id":2L, "param1":2L}
    private Object wrapCollection(final Object object) {
        // eg1: 因为object是Map，所以返回false
        if (object instanceof Collection) {
            ...
            return map;
        } else if (object != null && object.getClass().isArray()) { // eg1: object不为空，但是不是数组，返回false
            StrictMap<Object> map = new StrictMap<Object>();
            map.put("array", object);
            return map;
        }
        // eg1: 没有任何处理，原样返回 object={"id": 2L, "param1", 2L}
        return object;
    }
