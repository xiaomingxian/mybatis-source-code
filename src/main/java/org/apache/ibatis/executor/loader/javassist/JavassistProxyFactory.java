 ...
 *
 * Javassist Bytecode Proxy 代理类的执行速度是CGLIB的4倍左右，创建代理类的速度1倍左右
 *
 * 16核 Xeon 2.27GHZ 调用一千万次代理方法
 * 创建代理速度： JDK Proxy(7ms) > Javassist Proxy(36ms) > Javassist Bytecode Proxy(57ms) > GCLIB Proxy(86ms)
 * 代理运行速度： Javassist Bytecode Proxy(71ms) > GCLIB Proxy(234ms) > JDK Proxy(235ms) > Javassist Proxy(459ms)
 *
    ...
    private static class EnhancedResultObjectProxyImpl implements MethodHandler {
        ...
        public static Object createProxy(Object target, ResultLoaderMap lazyLoader, Configuration configuration,
            ...
            EnhancedResultObjectProxyImpl callback =
                    new EnhancedResultObjectProxyImpl(type, lazyLoader, configuration, objectFactory,
    ...
    private static class EnhancedDeserializationProxyImpl extends AbstractEnhancedDeserializationProxy
        ...
        public static Object createProxy(Object target, Map<String, ResultLoaderMap.LoadPair> unloadedProperties,
            ...
            EnhancedDeserializationProxyImpl callback =
                    new EnhancedDeserializationProxyImpl(type, unloadedProperties, objectFactory, constructorArgTypes,
                            constructorArgs);
            Object enhanced = crateProxy(type, callback, constructorArgTypes, constructorArgs);
            PropertyCopier.copyBeanProperties(type, target, enhanced);
            return enhanced;
